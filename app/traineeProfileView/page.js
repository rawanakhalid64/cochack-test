  ...
  const ProfileImage = () => {
    ...
    return (
      <div className="relative w-full h-full">
        <Image
          src={profileImageUrl || "https://thumbs.dreamstime.com/b/default-profile-picture-avatar-photo-placeholder-vector-illustration-default-profile-picture-avatar-photo-placeholder-vector-189495158.jpg"}
          alt="Profile"
          fill
          className="object-cover rounded-lg"
          onError={(e) => {
            console.error('Image load error:', e);
            setProfileImageUrl("https://thumbs.dreamstime.com/b/default-profile-picture-avatar-photo-placeholder-vector-illustration-default-profile-picture-avatar-photo-placeholder-vector-189495158.jpg");
          }}
        />
      </div>
    );
